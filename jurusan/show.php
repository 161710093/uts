...
<legend>Show Data Jurusan</legend>
...
<p>
Nilai Lulus:
<input type="text" name="nilailulus" value="<?php echo $data['nilai_lulus'];?>" readonly/> 
</p>
</form>
</fieldset>
<br><center><a class="btn btn-primary" href="lihatdatajurusan.php"> << Tabel Jurusan</a></center>
