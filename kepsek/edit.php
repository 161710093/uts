...
<center>
<h1>Edit Data Kepsek</h1>
</center>
<form action="simpanedit.php" method="post">
<?php
include ('koneksi.php');
    $id   =$_GET['id'];
    $k  =mysqli_query($koneksi,"SELECT * FROM kepsek WHERE id='$id'");
    $data =mysqli_fetch_array($k);
?>
<fieldset style="width: 50%; margin: auto;">
<legend>Edit Data Kepsek</legend>
<input type="hidden" name="id" value="<?php echo $data['id'];?>">
Nip:
<input type="number" name="nip" value="<?php echo $data['nip'];?>" required/> 
</p>
<p>
Nama Kepala Sekolah:
...
<br>
<center><a class="btn btn-primary" href="lihatdatakepsek.php"> << Table Kepsek</a></center>
