...
<legend>Show Data Pendaftar</legend>
...
<p>
Tempat lahir:
<input type="text" name="tempatlahir" value="<?php echo $data['tempat_lahir'];?>" readonly/> 
</p>
Tanggal Lahir:
<input type="text" name="tanggallahir" value="<?php echo $data['tanggal_lahir'];?>" readonly/> 
</p>
Jenis Kelamin:
<input type="text" name="jeniskelamin" value="<?php echo $data['jenis_kelamin'];?>" readonly/> 
</p>
Agama:
...
<br>
<center><a class="btn btn-primary" href="lihatdatapendaftar.php"> << Tabel Pendaftar</a></center>
