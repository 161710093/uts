...
<table class="table table-bordered">
	...
	<th style="background-color: lime">Nama Pendaftar</th>
	<th style="background-color: lime">Tempat Lahir</th>
	<th style="background-color: lime">Tanggal Lahir</th>
	<th style="background-color: lime">Jenis Kelamin</th>
	<th style="background-color: lime">Agama</th>
	<th style="background-color: lime">Phone</th>
