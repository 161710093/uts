...
<center>
<h1>Show Data Penguji</h1>
</center>
<?php
include ('koneksi.php');
    $id   =$_GET['id'];
    $k  =mysqli_query($koneksi,"SELECT * FROM penguji WHERE id='$id'");
    $data =mysqli_fetch_array($k);
?>
<fieldset style="width: 50%; margin: auto;">
<legend>Show Data Penguji</legend>
...
<p>
Jabatan:
<input type="text" name="penguji" value="<?php echo $data['jabatan'];?>" readonly/> 
</p>
</form>
</fieldset>
<br>
<center><a href="lihatdatapenguji.php"> << Tabel Penguji</a></center>
